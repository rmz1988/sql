...
-- changeset lichen:2016111301
CREATE TABLE leader_income (
  id         INT PRIMARY KEY AUTO_INCREMENT,
  userId     VARCHAR(60) COMMENT '用户Id',
  money      VARCHAR(20)     DEFAULT '0.00'
  COMMENT '领导奖收入',
  createTime VARCHAR(10) COMMENT '收入日期'
)
  COMMENT '待结算领导奖记录，结算后清除'
  ENGINE = InnoDB;
...
-- changeset lichen:2016120501
ALTER TABLE purchase_apply ADD COLUMN fee VARCHAR(20) DEFAULT '0.00'
COMMENT '手续费';
ALTER TABLE purchase_apply ADD COLUMN realMoney VARCHAR(20) DEFAULT '0.00'
COMMENT '实际到账金额';

-- changeset lichen:2016120502
UPDATE purchase_apply
SET fee = '0.00', realMoney = money;
